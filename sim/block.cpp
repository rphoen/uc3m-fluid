...
// Essentially, need to find any blocks with any combination of x+-1, y+-1, and
// z+-1 Can be up to 26... BUT!!! CAN BE LESS!!!

// <x+1, y, z>  <x+1, y+1, z>  <x+1, y-1, z>  <x+1, y+1, z+1>  <x+1, y+1, z-1>
// <x+1, y-1, z+1>  <x+1, y-1, z-1>  <x+1, y, z+1>  <x+1, y, z-1> <x-1, y, z>
// <x-1, y+1, z>  <x-1, y-1, z>  <x-1, y+1, z+1>  <x-1, y+1, z-1>  <x-1, y-1,
// z+1>  <x-1, y-1, z-1>  <x-1, y, z+1>  <x-1, y, z-1> <x, y, z>    <x,   y+1,
// z>  <x,   y-1, z>  <x,   y+1, z+1>  <x,   y+1, z-1>  <x,   y-1, z+1>  <x,
// y-1, z-1>  <x,   y, z+1>  <x,   y, z-1>
